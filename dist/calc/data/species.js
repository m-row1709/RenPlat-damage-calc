...
var RBY = {
    ...
    Beedrill: {
        types: ['Bug', 'Poison'],
        bs: { hp: 65, at: 115, df: 40, sp: 95, sl: 45 },
        weightkg: 29.5
    },
    Bellsprout: {
        types: ['Grass', 'Poison'],
    ...
    Butterfree: {
        types: ['Bug', 'Flying'],
        bs: { hp: 60, at: 45, df: 45, sp: 90, sl: 80 },
        weightkg: 32
    },
    Caterpie: {
        types: ['Bug'],
    ...
    Dewgong: {
        types: ['Water', 'Ice'],
        bs: { hp: 90, at: 80, df: 80, sp: 70, sl: 95 },
        weightkg: 120
    },
    Diglett: {
        types: ['Ground'],
    ...
    'Farfetch\u2019d': {
        types: ['Normal', 'Flying'],
        bs: { hp: 55, at: 110, df: 60, sp: 110, sl: 58 },
        weightkg: 15
    },
    Fearow: {
        types: ['Normal', 'Flying'],
        bs: { hp: 65, at: 110, df: 65, sp: 100, sl: 61 },
        weightkg: 38
    },
    Flareon: { types: ['Fire'], bs: { hp: 110, at: 130, df: 60, sp: 95, sl: 110 }, weightkg: 25 },
    Gastly: {
        types: ['Ghost', 'Poison'],
    ...
    Jynx: {
        types: ['Ice', 'Psychic'],
        bs: { hp: 75, at: 40, df: 35, sp: 95, sl: 95 },
        weightkg: 40.6
    },
    Kabuto: {
        types: ['Rock', 'Water'],
    ...
    'Mr. Mime': {
        types: ['Psychic'],
        bs: { hp: 40, at: 35, df: 65, sp: 95, sl: 100 },
        weightkg: 54.5
    },
    ...
    Ninetales: {
        types: ['Fire'],
        bs: { hp: 73, at: 67, df: 75, sp: 109, sl: 100 },
        weightkg: 19.9
    },
    Oddish: {
        types: ['Grass', 'Poison'],
    ...
    Persian: { types: ['Normal'], bs: { hp: 65, at: 80, df: 60, sp: 115, sl: 65 }, weightkg: 32 },
    Pidgeot: {
        types: ['Normal', 'Flying'],
        bs: { hp: 83, at: 60, df: 70, sp: 101, sl: 70 },
        weightkg: 39.5
    },
    Pidgeotto: {
        types: ['Normal', 'Flying'],
    ...
    Raticate: {
        types: ['Normal'],
        bs: { hp: 55, at: 97, df: 70, sp: 113, sl: 50 },
        weightkg: 18.5
    },
    Rattata: {
        types: ['Normal'],
    ...
    Seaking: { types: ['Water'], bs: { hp: 80, at: 122, df: 80, sp: 78, sl: 80 }, weightkg: 39 },
    Seel: {
        types: ['Water'],
    ...
    Venomoth: {
        types: ['Bug', 'Poison'],
        bs: { hp: 70, at: 55, df: 60, sp: 90, sl: 90 },
        weightkg: 12.5
    },
    Venonat: {
        types: ['Bug', 'Poison'],
    ...
    Wigglytuff: {
        types: ['Normal'],
        bs: { hp: 140, at: 80, df: 55, sp: 55, sl: 50 },
        weightkg: 12
    },
    Zapdos: {
...
var GSC_PATCH = {
    ...
    Parasect: { bs: { sa: 55, sd: 90 } },
    Persian: { bs: { sa: 80, sd: 65 } },
    ...
    Ariados: {
        types: ['Bug', 'Poison'],
        bs: { hp: 70, at: 110, df: 70, sa: 50, sd: 60, sp: 80 },
        weightkg: 33.5
    },
    Azumarill: {
        types: ['Water'],
    ...
    Furret: { types: ['Normal'], bs: { hp: 95, at: 85, df: 65, sa: 45, sd: 55, sp: 105 }, weightkg: 32.5 },
    Girafarig: {
...
var ADV_PATCH = {
    ...
    Chimecho: {
        types: ['Psychic'],
        bs: { hp: 75, at: 40, df: 70, sa: 110, sd: 100, sp: 65 },
        weightkg: 1,
        abilities: { 0: 'Levitate' }
    },
    Clamperl: {
    ...
    Illumise: {
        types: ['Bug'],
        bs: { hp: 65, at: 33, df: 85, sa: 97, sd: 75, sp: 100 },
        abilities: { 0: 'Oblivious' },
        weightkg: 17.7
    },
    Jirachi: {
    ...
    Volbeat: {
        types: ['Bug'],
        bs: { hp: 65, at: 33, df: 75, sa: 107, sd: 75, sp: 100 },
        weightkg: 17.7,
...
var DPP_PATCH = {
    ...
    Tangela: { nfe: true },
    Togetic: { types: ['Fairy', 'Flying'], nfe: true },
    Trapinch: { types: ['Bug', 'Ground'] },
